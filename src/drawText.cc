...
DrawTextWorker::DrawTextWorker(Nan::Callback *callback, Magick::Image *image,
    double x_, double y_, std::string text_, DrawTextOptions *options_
): Nan::AsyncWorker(callback), image(image),
